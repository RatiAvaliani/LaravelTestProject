...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 03 2020 г., 01:37
...
(4, '2020_08_01_135134_user_tokens', 1),
(5, '2020_08_01_135539_user_request_logs', 1),
...
CREATE TABLE `users` (
  ...
  `is_verified` smallint(6) NOT NULL DEFAULT 1,
...
--
-- Структура таблицы `user_request_logs`
--
...
CREATE TABLE `user_request_logs` (
  ...
  `request_params` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Индексы таблицы `user_request_logs`
--
...
--
-- AUTO_INCREMENT для таблицы `user_request_logs`
--
ALTER TABLE `user_request_logs`
